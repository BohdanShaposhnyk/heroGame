...
/******/ 	var hotCurrentHash = "202a4d86210a473137c1"; // eslint-disable-line no-unused-vars
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    store.dispatch((0, _hero.levelUp)());
});
...
var _heroReducer = __webpack_require__(26);

var _heroReducer2 = _interopRequireDefault(_heroReducer);
...
var configureStore = function configureStore() {
    ...
    return (0, _redux.createStore)(_heroReducer2.default, middleware);
}; /**
    * Created by bohdan on 20.02.2018.
    */
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(0), __webpack_require__(20)(module)))
...
var xp = function xp() {
    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : initialState.xp;
    var action = arguments[1];

    switch (action.type) {
        case _hero2.default.GAIN_XP:
...
var level = function level() {
    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : initialState.level;
    var action = arguments[1];

    switch (action.type) {
        case _hero2.default.LEVEL_UP:
            return state + 1;
        default:
            return state;
    }
...
var position = function position() {
    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : initialState.position;
    var action = arguments[1];

    switch (action.type) {
        case _hero2.default.MOVE:
...
var stats = function stats() {
    ...
    switch (action.type) {
        case _hero2.default.DRINK_POTION:
            health = Math.min(health + 20, maxHealth);
            return _extends({}, state, { health: health });
        case _hero2.default.TAKE_DAMAGE:
...
var inventory = function inventory() {
    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : initialState.inventory;
    var action = arguments[1];
    var potions = state.potions;


    switch (action.type) {
        case _hero2.default.DRINK_POTION:
            potions = Math.max(0, potions - 1);
            return _extends({}, state, { potions: potions });
        default:
            return state;
    }
};

var hero = (0, _redux.combineReducers)({
    xp: xp,
    level: level,
    position: position,
    stats: stats,
...
exports.takeDamage = exports.drinkPotion = exports.move = exports.levelUp = exports.gainXp = undefined;
...
var gainXp = exports.gainXp = function gainXp(xp) {
    return {
        type: _hero2.default.GAIN_XP,
        payload: xp
    };
}; /**
    * Created by bohdan on 20.02.2018.
    */
var levelUp = exports.levelUp = function levelUp() {
    return {
        type: _hero2.default.LEVEL_UP
    };
};

var move = exports.move = function move(x, y) {
    return {
        type: _hero2.default.MOVE,
        payload: { x: x, y: y }
    };
};

var drinkPotion = exports.drinkPotion = function drinkPotion() {
    return {
        type: _hero2.default.DRINK_POTION
    };
};

var takeDamage = exports.takeDamage = function takeDamage(amount) {
    return {
        type: _hero2.default.TAKE_DAMAGE,
        payload: amount
    };
};
